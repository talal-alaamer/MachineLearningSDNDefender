    ...
    return _createClass(t, [{
        ...
        value: function() {
            ...
            $(document).on("change", ".custom-file > .custom-file-input", function() {
                var e = this.files
                  ...
                  , a = t.data("label");
                if (t.text(e.length + " files selected"),
                e.length <= 2) {
        ...
        value: function() {
            $(document).on("click", '[data-toggle="password"]', function(e) {
                ...
                var t = $(this).attr("href")
                  ...
                  , n = o ? "text" : "password"
                  , s = o ? "Hide" : "Show";
                $(this).children(".fa, .far").toggleClass("fa-eye fa-eye-slash", i),
                $(this).children().last().text(s),
                a.prop("type", n)
            })
        }
    }, {
        ...
        value: function() {
            ...
            $(".modal-dialog-scrollable .modal-body, .modal-drawer .modal-body").on("scroll", function() {
                ...
                e.prev().toggleClass("modal-body-scrolled", a),
                e.next().toggleClass("modal-body-scrolled", i)
            })
        }
    }, {
        ...
        value: function() {
            return $(".aside-backdrop").addClass("show"),
            $(".aside-backdrop")
        }
    }, {
        key: "hideAsideBackdrop",
        value: function() {
            return $(".aside-backdrop").removeClass("show"),
            $(".aside-backdrop")
        }
    }, {
        key: "showAside",
        ...
        value: function() {
            ...
            a.on("click", function() {
                ...
                a.toggleClass("active", !e),
                e ? t.hideAside() : t.showAside()
            })
        }
    }, {
        key: "getMenuOptions",
        ...
        value: function() {
            var e;
            window.StackedMenu && this.isExists("#stacked-menu") && (this.stackedMenu = new StackedMenu(this.getMenuOptions()),
        ...
        value: function() {
            void 0 !== this.stackedMenu && (this.stackedMenu.compact(!0).hoverable(!0),
            this.hasCompactMenu = !0,
            localStorage.setItem("hasCompactMenu", !0),
        ...
        key: "expandAsideMenu",
        value: function() {
            void 0 !== this.stackedMenu && (this.stackedMenu.compact(!1).hoverable(!1),
            this.hasCompactMenu = !1,
            localStorage.setItem("hasCompactMenu", !1),
        ...
        value: function() {
            var e = $(".app");
            void 0 !== this.stackedMenu && (!this.isToggleScreenUp() || e.hasClass("has-fullwidth") ? (this.stackedMenu.compact(!1).hoverable(!1),
            e.removeClass("has-compact-menu")) : (this.stackedMenu.compact(this.hasCompactMenu).hoverable(this.hasCompactMenu),
        ...
        key: "bootstrapSelect",
        value: function() {
            $.fn.selectpicker && ($.fn.selectpicker.Constructor.DEFAULTS.style = "",
        ...
        key: "select2",
        value: function() {
            $.fn.select2 && ($.fn.select2.defaults.set("width", "100%"),
        ...
        value: function() {
            window.Tribute && $('[data-toggle="tribute"]').each(function() {
                ...
                1 == t.itemTemplate && (t.menuItemTemplate = function(e) {
        ...
        key: "flatpickr",
        value: (i = function() {
            window.flatpickr && (flatpickr.defaultConfig.disableMobile = !0,
            $('[data-toggle="flatpickr"]').each(function() {
                var e = $(this).data();
                e.plugins = [],
                e.disable = e.disables || [],
                e.defaultDate = e.defaultDates || null,
                e.confirmdate && e.plugins.push(new confirmDatePlugin({
                    showAlways: !0
                })),
                e.weekselect && e.plugins.push(new weekSelect({})),
                e.monthselect && e.plugins.push(new monthSelectPlugin({
                    shorthand: !0,
                    dateFormat: "m/y",
                    altFormat: "F Y"
                })),
        ...
        value: function() {
            window.noUiSlider && $('[data-toggle="nouislider"]').each(function() {
                var e = $(this).data();
                window.wNumb && e.formatWnumb && (e.format = wNumb(e.formatWnumb)),
                noUiSlider.create(this, e)
            })
        }
    }, {
        key: "summernote",
        ...
        value: function() {
            window.vanillaTextMask && $("[data-mask]").each(function() {
                ...
                "cazip" == a ? t.pipe = function(e) {
                    return e.toUpperCase()
                }
                : "email" == a ? t.mask = textMaskAddons.emailMask || [] : "currency" == a ? (t.prefix = t.prefix || "",
                t.mask = textMaskAddons.createNumberMask ? textMaskAddons.createNumberMask(t) : []) : "percentage" == a && (t.prefix = "",
                t.suffix = "%",
                t.mask = textMaskAddons.createNumberMask ? textMaskAddons.createNumberMask(t) : []),
                t.autoCorrectDate && (e = textMaskAddons.createAutoCorrectedDatePipe ? textMaskAddons.createAutoCorrectedDatePipe(t.autoCorrectDate) : null,
                t.pipe = e),
        ...
        value: (a = function() {
            window.zxcvbn && $(".form-strength-meter").each(function() {
                ...
                $(i).on("keyup", function() {
                    ...
                    "" !== e ? ($(o).removeClass("d-none ".concat(s.join(" "))).addClass("".concat(s[t.score])).css("width", a),
                    $(n).html("<strong>".concat(t.feedback.warning, "</strong> ").concat(t.feedback.suggestions))) : ($(o).addClass("d-none"),
                    $(n).html(""))
                })
            })
        }
